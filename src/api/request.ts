...
export default {
   ...
   */
  get<R = any>(url: string, params?: AnyObj, options?: AxiosRequestConfig): AxiosPromise<R> | R {
    return ajax<R>('get', url, params, options);
  },

  getBlob<R = any>(url: string, params?: AnyObj, options: AxiosRequestConfig = {}): AxiosPromise<R> | R {
    options.responseType = 'blob';
    options.timeout = 60 * 1000;
    return ajax<R>('get', url, params, options);
  },

  post<R = any>(url: string, params?: AnyObj, options?: AxiosRequestConfig): AxiosPromise<R> | R {
    return ajax<R>('post', url, params, options);
  },

  put<R = any>(url: string, params?: AnyObj, options?: AxiosRequestConfig): AxiosPromise<R> | R {
    return ajax<R>('put', url, params, options);
  },

  delete<R = any>(url: string, params?: AnyObj, options?: AxiosRequestConfig): AxiosPromise<R> | R {
